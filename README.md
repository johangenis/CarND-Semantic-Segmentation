...
* [![Semantic Segmentation: Pretoria, South-Africa Video Footage](https://github.com/johangenis/CarND-Semantic-Segmentation/blob/examples/pretVehTestVideo3.jpeg)](https://youtu.be/3KAPPjAW-AA) pretVehDetTest_720by480_210-475_out.mp4 - This is a video taken in Pretoria, South-Africa with a hand-held iPhone 8.(Please note that South Africa is a left-hand drive country.) Performance on this video is average, and what is interesting to note, is that painted islands on the road are classified a non-road(for the most part) by the FCN model.
* [![Semantic Segmentation: Harder Challenge Video](https://github.com/johangenis/CarND-Semantic-Segmentation/blob/examples/harderChallengeVideo2.jpg)](https://youtu.be/bANJEGZi1ow) harder_challenge_video-720by576_out.mp4 - A video taken from the Advanced Lane Finding project was used here, and again performance is not optimal, especially with darkly shaded areas.  Road surface is correctly identified plus minus 60% of the time.
* [![Semantic Segmentation: Random Video](https://github.com/johangenis/CarND-Semantic-Segmentation/blob/examples/Video1_1.jpg)](https://youtu.be/0SA6t1UIHNI) testVideo1_out.mp4 - This is a video taken randomly from the internet. Performance seems to be better on this video, compared to the other 2.
